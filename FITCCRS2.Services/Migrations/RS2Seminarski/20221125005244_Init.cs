        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PredavacId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Ime = table.Column<string>(type: "nchar(100)", fixedLength: true, maxLength: 100, nullable: true),
                    Prezime = table.Column<string>(type: "nchar(100)", fixedLength: true, maxLength: 100, nullable: true),
                    DogadjaId = table.Column<int>(type: "int", nullable: true),
                    Ustanova = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipSponzorstva = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    KategorijaID = table.Column<int>(type: "int", nullable: true),
                    SponzorKategorije = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projekat_Kategorija",
                        column: x => x.KategorijaID,
                        principalTable: "Kategorija",
                        principalColumn: "KategorijaID");
                    table.ForeignKey(
                        name: "FK_Projekat_Tim",
                        column: x => x.TimID,
                        principalTable: "Tim",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PredavacId = table.Column<int>(type: "int", nullable: false),
                    DogadjaId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PredavacDogadjaj", x => new { x.PredavacId, x.DogadjaId });
                    table.ForeignKey(
                        name: "FK_PredavacDogadjaj_Dogadjaj",
                        column: x => x.DogadjaId,
