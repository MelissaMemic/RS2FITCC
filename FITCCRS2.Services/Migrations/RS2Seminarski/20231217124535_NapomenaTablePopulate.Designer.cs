...
namespace FITCCRS2.Services.Migrations.RS2Seminarski
{
    ...
    [Migration("20231217124535_NapomenaTablePopulate")]
    partial class NapomenaTablePopulate
    {
            ...
            modelBuilder.Entity("FITCCRS2.Services.Database.ApiResource", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 12, 17, 13, 45, 34, 536, DateTimeKind.Local).AddTicks(820),
            ...
            modelBuilder.Entity("FITCCRS2.Services.Database.ApiResourceSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ApiResourceId = 1,
                            Created = new DateTime(2023, 12, 17, 13, 45, 34, 536, DateTimeKind.Local).AddTicks(940),
                            Type = "SharedSecret",
            ...
            modelBuilder.Entity("FITCCRS2.Services.Database.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2023, 12, 17, 13, 45, 34, 536, DateTimeKind.Local).AddTicks(1010),
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2023, 12, 17, 13, 45, 34, 536, DateTimeKind.Local).AddTicks(1020),
                            DeviceCodeLifetime = 300,
                            EnableLocalLogin = true,
                            Enabled = true,
                            FrontChannelLogoutSessionRequired = true,
            ...
            modelBuilder.Entity("FITCCRS2.Services.Database.ClientSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            Created = new DateTime(2023, 12, 17, 13, 45, 34, 536, DateTimeKind.Local).AddTicks(1080),
                            Type = "SharedSecret",
                        ...
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            Created = new DateTime(2023, 12, 17, 13, 45, 34, 536, DateTimeKind.Local).AddTicks(1090),
                            Type = "SharedSecret",
                            Value = "mvcbFoR2Z9+D9UMKjmSJ3rngEopZ+G/oaH+EafS3BLo="
                        });
                });
            ...
            modelBuilder.Entity("FITCCRS2.Services.Database.IdentityResource", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 12, 17, 13, 45, 34, 536, DateTimeKind.Local).AddTicks(1120),
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2023, 12, 17, 13, 45, 34, 536, DateTimeKind.Local).AddTicks(1130),
            ...
            modelBuilder.Entity("FITCCRS2.Services.Database.Napomena", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            NapomenaId = 1,
                            Poruka = "Takmicar pokazuje interes.",
                            UserName = "sponzor",
